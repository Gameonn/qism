...
$image	 = $_FILES['image'];
$about 	 = $_REQUEST['about']?$_REQUEST['about']:'';
$image_path = '';
$user_profile_info = '';
$user = new Users;
...
if($user_id){
	//save image//
	$user->saveUserProfile($user_id,$image_path,$about,$image_id);
...
echo json_encode(array('success'=>$success,'msg'=>$msg,'user_id'=>$user_id,'profile'=>$profile));
